...
function HomePage() {
  ...
  return (
    <div>
      <PageHeader
        title={t("goodMorning").replace("Priya", businessName || "Priya").replace("प्रिया", businessName || "प्रिया").replace("பிரியா", businessName || "பிரியா").replace("প্রিয়া", businessName || "প্রিয়া")}
